locals {
  selected_subnet_keys_ecs-agent = ["private-ecs-agent-2a", "private-ecs-agent-2b"]
  selected_subnet_keys_ecs-telemetry = ["private-ecs-telemetry-2a", "private-ecs-telemetry-2b"]
  selected_subnet_keys_ecs = ["private-ecs-2a", "private-ecs-2b"]
  selected_subnet_keys_ecr-dkr = ["private-ecr-dkr-2a", "private-ecr-dkr-2b"]
  selected_subnet_keys_ecr-api = ["private-ecr-api-2a", "private-ecr-api-2b"]
  selected_subnet_keys_ssm = ["private-ssm-2a", "private-ssm-2b"]
  selected_subnet_keys_ec2messages = ["private-ec2messages-2a", "private-ec2messages-2b"]
  selected_subnet_keys_ssmmessages = ["private-ssmmessages-2a", "private-ssmmessages-2b"]
  selected_subnet_keys_cloudwatch = ["private-cloudwatch-2a", "private-cloudwatch-2b"]
